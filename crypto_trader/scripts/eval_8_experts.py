"""
Evaluate 8 MoE experts independently under next_bar (corrected) execution.
...
Usage:
    PYTHONPATH=. python crypto_trader/scripts/eval_8_experts.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate 8 MoE experts independently under next_bar execution"
    )
    parser.add_argument(
        "--execution-mode",
        default="next_bar",
